					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-lg-6 text-left">
								<!-- <div class="line text-success"> echo $registlinename."(".$lineNo.")";</div> -->
						...
						?>
							...
							<div class="row justify-content-center text-center">
								...
								<!-- <input type="text" name="" id="progress_max"> -->
						</div>
						<div class="row justify-content-center text-center">
  <div id="app"></div>
<!-- count down button for trial  -->
